...
segment_8_dir = None
# Check in 03-temp directory first
if os.path.exists('03-temp'):
    for item in os.listdir('03-temp'):
        if item.startswith('SEGMENT_8_'):
            segment_8_dir = f'03-temp/{item}'
            break
...
elif segment_8_dir and os.path.exists(f"{segment_8_dir}/segment_8_placeholder.mp4"):
    print("✅ Segment 8 placeholder found!")
...
segments_dir = "03-temp/SMART_DOC_20251107_201335/SMART_DOC_20251107_201335"
