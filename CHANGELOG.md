...
- chore: release v2.0.0 [skip ci] (ea4eb39e)
- fix(ci): resolve 3 CI/CD failures from integration test merge (67562180)
- test: add Firebase emulator-backed integration test suite (#35) (fb306610)
- feat(observability): add OpenTelemetry tracing and structured logging (#34) (9878747b)
- test: add comprehensive unit test suite (1,104 tests across 53 files) (044435e3)
- refactor(auth): consolidate to single cookie, single module, eliminate XSS-vulnerable fallback (0d3df5d1)
- chore: ignore beads last-touched file (c4ecce95)
- fix(auth): prevent AbortController from aborting session cookie POST during navigation (#31) (82d96c20)
- docs(CLAUDE.md): improve architecture coverage and add build gotchas (#32) (0c95ec18)
